 ...
 * @return
 */
Quantity Order::getQuantityFilled() const {
    return getQuantity() - getQuantityRemaining();
}
...
/**
 * @brief Fill the order and update its status and quantity
 * @param fillQuantity Number of units to fill order by
 */
